...
<body id="page-top">
    ...
    <header class="masthead text-center text-white">
        <div class="masthead-content">
            <div class="container px-5">
                <h3 class=" mb-0">Selamat datang di</h3>
                <h1 class="masthead-heading mb-0">W A R U N G</h1>
                <h2 class="masthead-subheading mb-0">Sate Kelinci Pak Angling</h2>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="p-5"><img style="width: 200%; height: 402px;" width="200px" class="img-fluid rounded-circle" src="<?php echo base_url("assets/img/4.jpg"); ?>" alt="..." /></div>
                </div>
